<template>
  <section id='foot_guide'>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position:absolute;width:0;height:0">
      <defs>
        <symbol viewBox="0 0 40 40" id="shouye">
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="shouyeActive">
          <defs>
    ...
    <section @click="gotoAddress('/')" class="guide_item">
      ...
      <font-awesome-layers v-if="$route.path == '/'" full-width class="fa-4x">
        <font-awesome-icon icon="circle" value="奋斗" style="color: #007AFF;" class="icon_font" />
        <font-awesome-layers-text value="奋斗" style="color:#000000" class="icon_font_value" />
      </font-awesome-layers>
      <div v-else>
